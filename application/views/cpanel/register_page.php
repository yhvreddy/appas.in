...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?=base_url()?>cpanel_assets/plugins/iCheck/square/blue.css">
...
<div class="register-box">
  <div class="register-logo">
    <a href="<?=base_url('cpanel/login')?>"><b>Admin</b>Login</a>
  </div>
  ...
  <div class="register-box-body">
    ...
    <form action="<?=base_url('cpanel/user/savenewuserdetails')?>" method="post">
      ...
      <div class="form-group has-feedback">
        <input type="tel" maxlength="10" required="" class="form-control" name="mobile" placeholder="Mobile">
    ...
    <a href="<?=base_url('cpanel/login')?>" class="text-center">I already have a membership</a>
  </div>
  <!-- /.form-box -->
</div>
<!-- /.register-box -->
...
<!-- jQuery 3 -->
<script src="<?=base_url()?>cpanel_assets/bower_components/jquery/dist/jquery.min.js"></script>
<!-- Bootstrap 3.3.7 -->
<script src="<?=base_url()?>cpanel_assets/bower_components/bootstrap/dist/js/bootstrap.min.js"></script>
<!-- iCheck -->
<script src="<?=base_url()?>cpanel_assets/plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
