...
<section>
<div class="container max-w-lg-down-none m-b-30">
<h2 class="h2 m-b-40">Store Locations</h2>
<div class="row">
<div class="col col-lg-7 d-flex flex-wrap align-items-start storeRow">
<div class="card storeCard">
<div class="card-body">
<div class="card-title"><img class="imgIcon" src="assets/icons/location.png" alt="cart"> KUKATPALLY</div>
<div class="card-text">
<p><span class="primaryTextColor">Address :</span> PLOT NO:- 45/1 , Subodaya colony</p>
<p><span class="primaryTextColor">Phone :</span> 040-40 39 38 37</p>
</div>
</div>
</div>
<div class="card storeCard">
<div class="card-body">
<div class="card-title"><img class="imgIcon" src="assets/icons/location.png" alt="cart"> MIYAPUR</div>
<div class="card-text">
<p><span class="primaryTextColor">Address :</span> PLOT NO:- 1-202 , Ambedkar nagar</p>
<p><span class="primaryTextColor">Phone :</span> 040-40 39 38 37</p>
</div>
</div>
</div>
<div class="card storeCard">
<div class="card-body">
<div class="card-title"><img class="imgIcon" src="assets/icons/location.png" alt="cart"> ATTAPUR</div>
<div class="card-text">
<p><span class="primaryTextColor">Address :</span> PLOT NO:- 4-A , Nalanda Nagar</p>
<p><span class="primaryTextColor">Phone :</span> 040-40 39 38 37</p>
</div>
</div>
</div>
<div class="card storeCard">
<div class="card-body">
<div class="card-title"><img class="imgIcon" src="assets/icons/location.png" alt="cart"> SRI NAGAR COLONY</div>
<div class="card-text">
<p><span class="primaryTextColor">Address :</span> PLOT NO:- 8-3-76/115 , Shalivahan Nagar, Yellareddy Guda</p>
<p><span class="primaryTextColor">Phone :</span> 040-40 39 38 37</p>
</div>
</div>
</div>
<div class="card storeCard">
<div class="card-body">
<div class="card-title"><img class="imgIcon" src="assets/icons/location.png" alt="cart"> KONDAPUR</div>
<div class="card-text">
<p><span class="primaryTextColor">Address :</span> 1-2/2 A , Kothaguda X Road, Near Masjid</p>
<p><span class="primaryTextColor">Phone :</span> 040-40 39 38 37</p>
</div>
</div>
</div>
</div>
<div class="col col-lg-5 d-flex align-items-center hide-md-down">
<img class="img-fluid" src="assets/map_ref.png">
</div>
</div>
</div>
</section>
<footer class="hide-md-down">
...
<li class="m-r-15 m-b-10">Email: <a href="cdn-cgi/l/email-protection.php" class="__cf_email__" data-cfemail="6b181e1b1b04191f2b04050712060e0a1f450205">[email&#160;protected]</a></li>
