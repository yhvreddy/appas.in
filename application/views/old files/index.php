		...
		<div class="container">
			...
			<div class="row align-items-end">
				<div class="col-md-4">
					...
					<img class="card-img-top img-fluid" src="<?=base_url()?>assets/images/freshmeat_img.png" alt="Fresh meat">
				...
				<div class="col-md-4">
					<div class="card bg-trasparent pointer m-b-30 w-100 align-items-center">
						<img class="card-img-top img-fluid" src="<?=base_url()?>assets/images/Delivery_boy.png" alt="Delivery boy">
						<div class="card-body d-flex justify-content-center">
				...
				<div class="col-md-4">
					<div class="card bg-trasparent pointer m-b-30 w-100 align-items-center">
						<img class="card-img-top img-fluid" src="<?=base_url()?>assets/images/Best_quality.png" alt="Best quality">
						<div class="card-body d-flex justify-content-center">
