		...
		<div class="container-fluid">
			<div class="row flex-wrap m-b-20">
				...
				<div class="col col-cust m-b-20 flex-grow-1">
					...
					<ul type="none" class="p-l-0">
						<li class="m-r-15 m-b-10"><a href="<?=base_url('about')?>">About Us</a></li>
						<li class="m-r-15 m-b-10"><a href="<?=base_url('returns')?>">Shipping & Returns</a></li>
						<li class="m-r-15 m-b-10"><a href="<?=base_url('terms_cond')?>">Terms & Conditions</a></li>
						<li class="m-r-15 m-b-10"><a href="<?=base_url('privacy')?>">Privacy Policy</a></li>
					</ul>
				</div>
