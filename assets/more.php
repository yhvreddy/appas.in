...
<ul class="nav mobile-nav mb-1 show-md-down">
	...
	<li class="nav-item">
	<a class="nav-link text-capitalize active" href="more.php">More</a>
	</li>
</ul>
...
<img class="card-img-top pointer" onerror="this.onerror=null;this.src='assets/placeholder.png';" src="../cdn.onlymeat.in/images/products/12ed69f55220d972e5c9ac20b1f4e2b5.jpg" onclick="goto('/more/everest-chicken-masala')" alt="Chicken Masala">
</div>

</figure>
<div class="card-body d-flex flex-column justify-content-between">
<h5 class="card-title d-flex flex-column">
<a href="more/everest-chicken-masala.php" class="m-b-5">
<span class="prod-title">Chicken Masala</span>
</a>
<span class="rate m-b-5">&#x20B9; 5 per Pack</span>
</h5>
<div class="prod-desc m-b-10 hide-md-down">Priya Chicken Masala</div>
...
<option value="1">1 Pack &#x00A0;&#x00A0;&#x20B9 5</option><option value="2">2 Packs &#x00A0;&#x00A0;&#x20B9 10</option><option value="3">3 Packs &#x00A0;&#x00A0;&#x20B9 15</option><option value="4">4 Packs &#x00A0;&#x00A0;&#x20B9 20</option><option value="5">5 Packs &#x00A0;&#x00A0;&#x20B9 25</option><option value="6">6 Packs &#x00A0;&#x00A0;&#x20B9 30</option><option value="7">7 Packs &#x00A0;&#x00A0;&#x20B9 35</option><option value="8">8 Packs &#x00A0;&#x00A0;&#x20B9 40</option><option value="9">9 Packs &#x00A0;&#x00A0;&#x20B9 45</option><option value="10">10 Packs &#x00A0;&#x00A0;&#x20B9 50</option> </select>
<div class="invalid-feedback"></div>
</div>
</div>
<div class="actionBtns d-flex flex-row justify-content-between w-100">
<button type="button" class="btn primaryBtnInverse btn-add-cart addToCart" onclick="addToCart(21, false, '')"><i class="material-icons m-r-10">check</i> Add To Cart</button>
<button type="button" class="btn primaryBtn" onclick="addToCart(21, true, '')">Buy Now</button>
</div>
</div>
</div>
</div>
<div class="col-lg-4 col-md-6 d-flex">
<div class="card productCard flex-grow-1" id="product_47" data-price="5">
<figure>
<div class="prodImgCon">
<img class="card-img-top pointer" onerror="this.onerror=null;this.src='assets/placeholder.png';" src="../cdn.onlymeat.in/images/products/c01c5897904da3cba4a3951d8b064769.jpg" onclick="goto('/more/eastern-mutton-masala')" alt="Mutton masala">
</div>

</figure>
<div class="card-body d-flex flex-column justify-content-between">
<h5 class="card-title d-flex flex-column">
<a href="more/eastern-mutton-masala.php" class="m-b-5">
<span class="prod-title">Mutton masala</span>
</a>
<span class="rate m-b-5">&#x20B9; 5 per Pack</span>
</h5>
<div class="prod-desc m-b-10 hide-md-down">Priya Mutton Masala</div>
<div class="card-text d-flex align-items-center m-b-15 m-b-xs-10">
<span class="p-r-25 smallText whiteSpace-nw">Select Weight</span>
<div class="form-group m-b-0 w-75">
<select class="custom-select quantitySelector" required>
...
<div class="actionBtns d-flex flex-row justify-content-between w-100">
<button type="button" class="btn primaryBtnInverse btn-add-cart addToCart" onclick="addToCart(47, false, '')"><i class="material-icons m-r-10">check</i> Add To Cart</button>
<button type="button" class="btn primaryBtn" onclick="addToCart(47, true, '')">Buy Now</button>
</div>
</div>
</div>
</div>
<div class="col-lg-4 col-md-6 d-flex">
<div class="card productCard flex-grow-1" id="product_46" data-price="5">
<figure>
<div class="prodImgCon">
<img class="card-img-top pointer" onerror="this.onerror=null;this.src='assets/placeholder.png';" src="../cdn.onlymeat.in/images/products/05ad3af2ee8aa5a4ea7d84ef18c867d5.jpg" onclick="goto('/more/eastern-fish-masala')" alt="Fish masala">
</div>

</figure>
<div class="card-body d-flex flex-column justify-content-between">
<h5 class="card-title d-flex flex-column">
<a href="more/eastern-fish-masala.php" class="m-b-5">
<span class="prod-title">Fish masala</span>
</a>
<span class="rate m-b-5">&#x20B9; 5 per Pack</span>
</h5>
<div class="prod-desc m-b-10 hide-md-down">Priya Fish Masala</div>
<div class="card-text d-flex align-items-center m-b-15 m-b-xs-10">
<span class="p-r-25 smallText whiteSpace-nw">Select Weight</span>
<div class="form-group m-b-0 w-75">
<select class="custom-select quantitySelector" required>
...
<div class="actionBtns d-flex flex-row justify-content-between w-100">
<button type="button" class="btn primaryBtnInverse btn-add-cart addToCart" onclick="addToCart(46, false, '')"><i class="material-icons m-r-10">check</i> Add To Cart</button>
<button type="button" class="btn primaryBtn" onclick="addToCart(46, true, '')">Buy Now</button>
</div>
</div>
</div>
</div>
<div class="col-lg-4 col-md-6 d-flex">
<div class="card productCard flex-grow-1" id="product_68" data-price="5">
<figure>
<div class="prodImgCon">
<img class="card-img-top pointer" onerror="this.onerror=null;this.src='assets/placeholder.png';" src="../cdn.onlymeat.in/images/products/230db1f027dd6de360885450be83b7d3.png" onclick="goto('/more/everest-garam-masala')" alt="Garam Masala">
</div>

</figure>
<div class="card-body d-flex flex-column justify-content-between">
<h5 class="card-title d-flex flex-column">
<a href="more/everest-garam-masala.php" class="m-b-5">
<span class="prod-title">Garam Masala</span>
</a>
<span class="rate m-b-5">&#x20B9; 5 per Pack</span>
</h5>
<div class="prod-desc m-b-10 hide-md-down">Priya Garam Masala</div>
<div class="card-text d-flex align-items-center m-b-15 m-b-xs-10">
<span class="p-r-25 smallText whiteSpace-nw">Select Weight</span>
<div class="form-group m-b-0 w-75">
<select class="custom-select quantitySelector" required>
...
<div class="actionBtns d-flex flex-row justify-content-between w-100">
<button type="button" class="btn primaryBtnInverse btn-add-cart addToCart" onclick="addToCart(68, false, '')"><i class="material-icons m-r-10">check</i> Add To Cart</button>
<button type="button" class="btn primaryBtn" onclick="addToCart(68, true, '')">Buy Now</button>
</div>
</div>
</div>
</div>
<div class="col-lg-4 col-md-6 d-flex">
<div class="card productCard flex-grow-1" id="product_56" data-price="5">
<figure>
<div class="prodImgCon">
<img class="card-img-top pointer" onerror="this.onerror=null;this.src='assets/placeholder.png';" src="../cdn.onlymeat.in/images/products/a134b3c51bd80b89983579d2c3da2409.jpg" onclick="goto('/more/garlic-ginger-paste')" alt="Garlic ginger paste">
</div>

</figure>
<div class="card-body d-flex flex-column justify-content-between">
<h5 class="card-title d-flex flex-column">
<a href="more/garlic-ginger-paste.php" class="m-b-5">
<span class="prod-title">Garlic ginger paste</span>
</a>
<span class="rate m-b-5">&#x20B9; 5 per Pack</span>
</h5>
<div class="prod-desc m-b-10 hide-md-down">Garlic Ginger paste</div>
<div class="card-text d-flex align-items-center m-b-15 m-b-xs-10">
<span class="p-r-25 smallText whiteSpace-nw">Select Weight</span>
<div class="form-group m-b-0 w-75">
<select class="custom-select quantitySelector" required>
...
<div class="actionBtns d-flex flex-row justify-content-between w-100">
<button type="button" class="btn primaryBtnInverse btn-add-cart addToCart" onclick="addToCart(56, false, '')"><i class="material-icons m-r-10">check</i> Add To Cart</button>
<button type="button" class="btn primaryBtn" onclick="addToCart(56, true, '')">Buy Now</button>
</div>
</div>
</div>
</div>
<div class="col-lg-4 col-md-6 d-flex">
<div class="card productCard flex-grow-1" id="product_70" data-price="20">
<figure>
<div class="prodImgCon">
<img class="card-img-top pointer" onerror="this.onerror=null;this.src='assets/placeholder.png';" src="../cdn.onlymeat.in/images/products/5608c0e9c137c9af66674b4805bc48a8.png" onclick="goto('more/index.php')" alt="Lemon and Leaves">
</div>

</figure>
<div class="card-body d-flex flex-column justify-content-between">
<h5 class="card-title d-flex flex-column">
<a href="more/index.php" class="m-b-5">
<span class="prod-title">Lemon and Leaves</span>
</a>
<span class="rate m-b-5">&#x20B9; 20 per Unit</span>
</h5>
<div class="prod-desc m-b-10 hide-md-down">Corainder leaves,Fresh Lemon, Fresh Mint leaves</div>
<div class="card-text d-flex align-items-center m-b-15 m-b-xs-10">
<span class="p-r-25 smallText whiteSpace-nw">Select Weight</span>
<div class="form-group m-b-0 w-75">
<select class="custom-select quantitySelector" required>
<option value="1">1 Unit &#x00A0;&#x00A0;&#x20B9 20</option><option value="2">2 Units &#x00A0;&#x00A0;&#x20B9 40</option><option value="3">3 Units &#x00A0;&#x00A0;&#x20B9 60</option><option value="4">4 Units &#x00A0;&#x00A0;&#x20B9 80</option><option value="5">5 Units &#x00A0;&#x00A0;&#x20B9 100</option><option value="6">6 Units &#x00A0;&#x00A0;&#x20B9 120</option><option value="7">7 Units &#x00A0;&#x00A0;&#x20B9 140</option><option value="8">8 Units &#x00A0;&#x00A0;&#x20B9 160</option><option value="9">9 Units &#x00A0;&#x00A0;&#x20B9 180</option><option value="10">10 Units &#x00A0;&#x00A0;&#x20B9 200</option> </select>
<div class="invalid-feedback"></div>
</div>
</div>
<div class="actionBtns d-flex flex-row justify-content-between w-100">
<button type="button" class="btn primaryBtnInverse btn-add-cart addToCart" onclick="addToCart(70, false, '')"><i class="material-icons m-r-10">check</i> Add To Cart</button>
<button type="button" class="btn primaryBtn" onclick="addToCart(70, true, '')">Buy Now</button>
</div>
</div>
</div>
</div>
<div class="col-lg-4 col-md-6 d-flex">
<div class="card productCard flex-grow-1" id="product_60" data-price="65">
<figure>
<div class="prodImgCon">
<img class="card-img-top pointer" onerror="this.onerror=null;this.src='assets/placeholder.png';" src="../cdn.onlymeat.in/images/products/1fcd1c153b782314a594f8868f634665.png" onclick="goto('/more/quail-10-birds')" alt="Quail (Each Bird)">
</div>

</figure>
<div class="card-body d-flex flex-column justify-content-between">
<h5 class="card-title d-flex flex-column">
<a href="more/quail-10-birds.php" class="m-b-5">
<span class="prod-title">Quail (Each Bird)</span>
</a>
<span class="rate m-b-5">&#x20B9; 65 per Unit</span>
</h5>
<div class="prod-desc m-b-10 hide-md-down">Quail Birds</div>
<div class="card-text d-flex align-items-center m-b-15 m-b-xs-15">
</div>
<div class="no-stock">
<a data-toggle="tooltip" title="arriving soon">No Stock <i class="fa fa-bullseye" style="color:#F00;"></i></a>
</div>
</div>
</div>
</div>
...
<li class="m-r-15 m-b-10">Email: <a href="cdn-cgi/l/email-protection.php" class="__cf_email__" data-cfemail="e695939696899492a689888a9f8b838792c88f88">[email&#160;protected]</a></li>
