...
<head>
  ...
  <link rel="stylesheet" href="<?=base_url()?>cpanel_assets/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
	<!-- jQuery 3 -->
  ...
  <![endif]-->
	<!-- DataTables -->
	<link rel="stylesheet" href="<?=base_url()?>cpanel_assets/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css">
  <!-- Google Font -->
  <link rel="stylesheet"
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?=$userdata[0]->reg_name?></span>
            </a>
              ...
              <li class="user-header">
                ...
                <div style="padding: 40px 0px 0px 0px">
                  ...
                  <div class="pull-right">
                    <a href="<?=base_url('cpanel/logout')?>" class="btn btn-default btn-flat">Sign out</a>
                  </div>
                </div>
              </li>
            </ul>
