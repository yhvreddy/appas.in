        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <?php if(isset($sitedetails) && count($sitedetails) != 0){ ?>
                <form role="form" method="post" action="<?=base_url('cpanel/dashboard/saveeditsitedetails')?>" enctype="multipart/form-data">
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group col-md-3">
                      <label for="exampleInputFile">Upload Logo <?php if(!empty($sitedetails[0]->site_logo)){?> <a href="<?=base_url($sitedetails[0]->site_logo)?>" style="padding: 0px 0px 0px 50px" target="_blank"> Uploaded Logo</a> <?php } ?> </label>
            ...
            <?php }else{ ?>
                <form role="form" method="post" action="<?=base_url('cpanel/dashboard/savesitedetails')?>" enctype="multipart/form-data">
                  <div class="box-body">
                    <div class="form-group col-md-3">
                        <label for="bannertitle">Site Name <span class="text-danger">*</span></label>
