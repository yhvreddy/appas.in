				...
				<nav class="navbar justify-content-start col-lg-11 col-md-12 d-flex">
					...
					<div class="d-flex justify-content-end flex-grow-1 order-xl-3">
						...
						<div class="d-flex align-items-center divider-r phoneNum">
							...
							<a href="tel:+91-40- 40 39 38 37" class="m-l-5 m-r-5">+91 8885883358</a>
						</div>
						...
						<!-- add to cart by ajax  -->
						<div class="cart d-flex align-items-center divider-r pointer" id="Addtocart_details"></div>

						<!-- data-id="loginSideNav" -->
						<?php if($this->isAccess == 0){ ?>
							<div class="d-flex align-items-center custSideNav pointer smallText signin">
								<a href="<?=base_url('loginregister')?>" style="text-decoration: none">SignUp or Login</a>
							</div> &nbsp;&nbsp;
						<?php }else{ ?>
							<div class="d-flex align-items-center custSideNav pointer smallText signin">
								...
								<a href="<?=base_url('shopping/orders')?>">MyOrders</a>&nbsp;&nbsp;
								<a href="<?=base_url('user/profile')?>">Profile</a>&nbsp;&nbsp;
								<a href="<?=base_url('accesss/logout')?>">Logout</a>
							</div>
						<?php } ?>
