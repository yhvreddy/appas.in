...
<li class="nav-item">
<a class="nav-link active" href="eggs.php">Eggs</a>
</li>
<li class="nav-item">
...
<div class="d-flex align-items-center m-r-10 flex-grow-1">
<i class="material-icons icon-left-open-big m-r-10 d-flex" onclick="goBack()"></i> <span class="text-capitalize">eggs Customization</span>
</div>
<div class="d-flex align-items-center openSeacrh">
...
<li class="nav-item">
<a class="nav-link text-capitalize active" href="eggs.php">Eggs</a>
</li>
<li class="nav-item">
...
<div class="card productCard flex-grow-1" id="product_36" data-price="75">
<figure>
<div class="prodImgCon">
<img class="card-img-top pointer" onerror="this.onerror=null;this.src='assets/placeholder.png';" src="../cdn.onlymeat.in/images/products/d395b2d7f6c9e8e2ffb5a624f735f5ad.png" onclick="goto('/eggs/organic-eggs-6-pack')" alt="Organic eggs (6 pack)">
</div>

</figure>
<div class="card-body d-flex flex-column justify-content-between">
<h5 class="card-title d-flex flex-column">
<a href="eggs/organic-eggs-6-pack.php" class="m-b-5">
<span class="prod-title">Organic eggs (6 pack)</span>
</a>
<span class="rate m-b-5">&#x20B9; 75 per Unit</span>
</h5>
<div class="prod-desc m-b-10 hide-md-down">Half a dozen neatly packed organic eggs from organically fed and bred farm chicken</div>
<div class="card-text d-flex align-items-center m-b-15 m-b-xs-15">
</div>
<div class="no-stock">
<a data-toggle="tooltip" title="coming soon">No Stock <i class="fa fa-bullseye" style="color:#F00;"></i></a>
</div>
</div>
</div>
</div>
<div class="col-lg-4 col-md-6 d-flex">
<div class="card productCard flex-grow-1" id="product_20" data-price="35">
<figure>
<div class="prodImgCon">
<img class="card-img-top pointer" onerror="this.onerror=null;this.src='assets/placeholder.png';" src="../cdn.onlymeat.in/images/products/7452a7ceedab22108e61cb4568b6f44d.png" onclick="goto('/eggs/eggs-6-pack')" alt="Eggs (6 pack)">
</div>

</figure>
<div class="card-body d-flex flex-column justify-content-between">
<h5 class="card-title d-flex flex-column">
<a href="eggs/eggs-6-pack.php" class="m-b-5">
<span class="prod-title">Eggs (6 pack)</span>
</a>
<span class="rate m-b-5">&#x20B9; 35 per Unit</span>
</h5>
<div class="prod-desc m-b-10 hide-md-down">Breakfast ready white eggs from hygienically fed and bred poultry chickens</div>
...
<option value="1">1 Unit &#x00A0;&#x00A0;&#x20B9 35</option><option value="2">2 Units &#x00A0;&#x00A0;&#x20B9 70</option><option value="3">3 Units &#x00A0;&#x00A0;&#x20B9 105</option><option value="4">4 Units &#x00A0;&#x00A0;&#x20B9 140</option><option value="5">5 Units &#x00A0;&#x00A0;&#x20B9 175</option><option value="6">6 Units &#x00A0;&#x00A0;&#x20B9 210</option><option value="7">7 Units &#x00A0;&#x00A0;&#x20B9 245</option><option value="8">8 Units &#x00A0;&#x00A0;&#x20B9 280</option><option value="9">9 Units &#x00A0;&#x00A0;&#x20B9 315</option><option value="10">10 Units &#x00A0;&#x00A0;&#x20B9 350</option> </select>
<div class="invalid-feedback"></div>
</div>
</div>
<div class="actionBtns d-flex flex-row justify-content-between w-100">
<button type="button" class="btn primaryBtnInverse btn-add-cart addToCart" onclick="addToCart(20, false, '')"><i class="material-icons m-r-10">check</i> Add To Cart</button>
<button type="button" class="btn primaryBtn" onclick="addToCart(20, true, '')">Buy Now</button>
</div>
</div>
</div>
</div>
<div class="col-lg-4 col-md-6 d-flex">
<div class="card productCard flex-grow-1" id="product_34" data-price="50">
<figure>
<div class="prodImgCon">
<img class="card-img-top pointer" onerror="this.onerror=null;this.src='assets/placeholder.png';" src="../cdn.onlymeat.in/images/products/591ee8a3981011715779beaac3020e60.png" onclick="goto('/eggs/brown-eggs-6-pack')" alt="Brown eggs (6 pack)">
</div>

</figure>
<div class="card-body d-flex flex-column justify-content-between">
<h5 class="card-title d-flex flex-column">
<a href="eggs/brown-eggs-6-pack.php" class="m-b-5">
<span class="prod-title">Brown eggs (6 pack)</span>
</a>
<span class="rate m-b-5">&#x20B9; 50 per Unit</span>
</h5>
<div class="prod-desc m-b-10 hide-md-down">Half dozen wild and uncaged country chicken eggs neatly and hygienically packed</div>
<div class="card-text d-flex align-items-center m-b-15 m-b-xs-10">
<span class="p-r-25 smallText whiteSpace-nw">Select Weight</span>
<div class="form-group m-b-0 w-75">
<select class="custom-select quantitySelector" required>
<option value="1">1 Unit &#x00A0;&#x00A0;&#x20B9 50</option><option value="2">2 Units &#x00A0;&#x00A0;&#x20B9 100</option><option value="3">3 Units &#x00A0;&#x00A0;&#x20B9 150</option><option value="4">4 Units &#x00A0;&#x00A0;&#x20B9 200</option><option value="5">5 Units &#x00A0;&#x00A0;&#x20B9 250</option><option value="6">6 Units &#x00A0;&#x00A0;&#x20B9 300</option><option value="7">7 Units &#x00A0;&#x00A0;&#x20B9 350</option><option value="8">8 Units &#x00A0;&#x00A0;&#x20B9 400</option><option value="9">9 Units &#x00A0;&#x00A0;&#x20B9 450</option><option value="10">10 Units &#x00A0;&#x00A0;&#x20B9 500</option> </select>
<div class="invalid-feedback"></div>
</div>
</div>
<div class="actionBtns d-flex flex-row justify-content-between w-100">
<button type="button" class="btn primaryBtnInverse btn-add-cart addToCart" onclick="addToCart(34, false, '')"><i class="material-icons m-r-10">check</i> Add To Cart</button>
<button type="button" class="btn primaryBtn" onclick="addToCart(34, true, '')">Buy Now</button>
</div>
</div>
</div>
</div>
<div class="col-lg-4 col-md-6 d-flex">
<div class="card productCard flex-grow-1" id="product_59" data-price="42">
<figure>
<div class="prodImgCon">
<img class="card-img-top pointer" onerror="this.onerror=null;this.src='assets/placeholder.png';" src="../cdn.onlymeat.in/images/products/71c7060e463fd6d998116be69cccc184.png" onclick="goto('/eggs/quail-eggs-6-pack')" alt="Quail Eggs (6 pack)">
</div>

</figure>
<div class="card-body d-flex flex-column justify-content-between">
<h5 class="card-title d-flex flex-column">
<a href="eggs/quail-eggs-6-pack.php" class="m-b-5">
<span class="prod-title">Quail Eggs (6 pack)</span>
</a>
<span class="rate m-b-5">&#x20B9; 42 per Unit</span>
</h5>
<div class="prod-desc m-b-10 hide-md-down">Quail Eggs</div>
<div class="card-text d-flex align-items-center m-b-15 m-b-xs-15">
</div>
<div class="no-stock"> 
...
<li class="m-r-15 m-b-10">Email: <a href="cdn-cgi/l/email-protection.php" class="__cf_email__" data-cfemail="b3c0c6c3c3dcc1c7f3dcdddfcaded6d2c79ddadd">[email&#160;protected]</a></li>
