...
<li class="nav-item">
<a class="nav-link active" href="prawns.php">Prawns</a>
</li>
<li class="nav-item">
...
<div class="d-flex align-items-center m-r-10 flex-grow-1">
<i class="material-icons icon-left-open-big m-r-10 d-flex" onclick="goBack()"></i> <span class="text-capitalize">prawns Customization</span>
</div>
<div class="d-flex align-items-center openSeacrh">
...
<li class="nav-item">
<a class="nav-link text-capitalize active" href="prawns.php">Prawns</a>
</li>
<li class="nav-item">
...
<div class="card productCard flex-grow-1" id="product_19" data-price="680">
<figure>
<div class="prodImgCon">
<img class="card-img-top pointer" onerror="this.onerror=null;this.src='assets/placeholder.png';" src="../cdn.onlymeat.in/images/products/107f74db0d13745da0a60087795d3562.jpg" onclick="goto('/prawns/prawns-large-size')" alt="Prawns (Large Size)">
</div>

</figure>
<div class="card-body d-flex flex-column justify-content-between">
<h5 class="card-title d-flex flex-column">
<a href="prawns/prawns-large-size.php" class="m-b-5">
<span class="prod-title">Prawns (Large Size)</span>
</a>
<span class="rate m-b-5">&#x20B9; 680 per Kg</span>
</h5>
<div class="prod-desc m-b-10 hide-md-down">High quality and large sized freshwater prawns cleaned and processed hygienically for consumption</div>
...
<button type="button" class="btn primaryBtnInverse btn-add-cart addToCart" onclick="addToCart(19, false, 'scheduled')"><i class="material-icons m-r-10">check</i> Add To Cart</button>
<button type="button" class="btn primaryBtn" onclick="addToCart(19, true, 'scheduled')">Buy Now</button>
</div>
<span class='pt-1 d-block condition-text text-danger del-warn-msg'>* Only Scheduled Delivery</span> </div>
</div>
</div>
<div class="col-lg-4 col-md-6 d-flex">
<div class="card productCard flex-grow-1" id="product_35" data-price="620">
<figure>
<div class="prodImgCon">
<img class="card-img-top pointer" onerror="this.onerror=null;this.src='assets/placeholder.png';" src="../cdn.onlymeat.in/images/products/f73ae9e8e9ccb301ee521a50a8e8ec1a.jpg" onclick="goto('/prawns/prawns-medium-size')" alt="Prawns (Medium size)">
</div>

</figure>
<div class="card-body d-flex flex-column justify-content-between">
<h5 class="card-title d-flex flex-column">
<a href="prawns/prawns-medium-size.php" class="m-b-5">
<span class="prod-title">Prawns (Medium size)</span>
</a>
 <span class="rate m-b-5">&#x20B9; 620 per Kg</span>
</h5>
<div class="prod-desc m-b-10 hide-md-down">High quality and bite sized freshwater prawns cleaned and hygienically processed for consumption.</div>
<div class="card-text d-flex align-items-center m-b-15 m-b-xs-10">
<span class="p-r-25 smallText whiteSpace-nw">Select Weight</span>
<div class="form-group m-b-0 w-75">
<select class="custom-select quantitySelector" required>
<option value="1">1 kg &#x00A0;&#x00A0;&#x20B9 620</option><option value="1.5">1.5 kg &#x00A0;&#x00A0;&#x20B9 930</option><option value="2">2 kg &#x00A0;&#x00A0;&#x20B9 1240</option><option value="2.5">2.5 kg &#x00A0;&#x00A0;&#x20B9 1550</option><option value="3">3 kg &#x00A0;&#x00A0;&#x20B9 1860</option><option value="3.5">3.5 kg &#x00A0;&#x00A0;&#x20B9 2170</option><option value="4">4 kg &#x00A0;&#x00A0;&#x20B9 2480</option> </select>
<div class="invalid-feedback"></div>
</div>
</div>
<div class="actionBtns d-flex flex-row justify-content-between w-100">
<button type="button" class="btn primaryBtnInverse btn-add-cart addToCart" onclick="addToCart(35, false, 'scheduled')"><i class="material-icons m-r-10">check</i> Add To Cart</button>
<button type="button" class="btn primaryBtn" onclick="addToCart(35, true, 'scheduled')">Buy Now</button>
</div>
<span class='pt-1 d-block condition-text text-danger del-warn-msg'>* Only Scheduled Delivery</span> </div>
</div>
</div>
...
<li class="m-r-15 m-b-10">Email: <a href="cdn-cgi/l/email-protection.php" class="__cf_email__" data-cfemail="ea999f9a9a85989eaa85848693878f8b9ec48384">[email&#160;protected]</a></li>
