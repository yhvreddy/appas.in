...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form action="<?=base_url('cpanel/login/user')?>" method="post">
      <div class="form-group has-feedback">
        <input type="email" class="form-control" name="login_id" placeholder="Email">
...
<!-- <a href="--><?//=base_url('cpanel/user/register')?><!--" class="text-center">Register a new membership</a>-->
